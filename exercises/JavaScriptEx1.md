...
1.	Copy the clone URL from your new repository ``JavaScript-<YOURACCOUNT>``
...
1.	Edit using the *Sublime Text Editor* the HTML file called ``FirstJS.html`` in your ``JavaScript`` folder.  Examine the code carefully and then open it in your browser using the URL [http://localhost/JavaScript/FirstJS.html](http://localhost/JavaScript/FirstJS.html).
